...
public class WCDriveConstants {
  ...
  public static final class Motors {
    ...
    /**
     * Ramp time applied by motor controllers, given as the number of seconds to
     * transition from 0 Amps to full current.  Greater values can help to limit
     * motor current draw, but may result in less responsive control.
     */
   ...
   **************************************************************************
   * NOTE:
   *   Constants provided in this class are for poor souls still measuring in
   *   IMPERIAL UNITS (fingers in mouth with gagging noises...).  Physical
   *   dimensions of drive base components entered here are automatically
   *   converted to equivalent SI unit values in constants below.
   **************************************************************************   
   */
   ...
   * Physical constants describing the drive train (Imperial units)
   * 
   * These constants are automatically calculated from values given in the
   * PhysicalImp class above.  They are not expected to be edited directly.
   */
  public static final class PhysicalSI {
    /** Width of the west coast drive tracks in meters */
    public static final double kTrackWidthMeters = Units.inchesToMeters(PhysicalImp.kTrackWidthInches);
    /** Radius of wheels in meters */
    public static final double kWheelDiameterMeters = Units.inchesToMeters(PhysicalImp.kWheelDiameterInches);
    /** Gear ratio applied between drive motors and wheels */
    ...
    public static final double kMetersPerEncoderTick = 
   ...
   * 
   * These constants must be empirically determined using the sysid utility and
   * by following instructions provided at:
